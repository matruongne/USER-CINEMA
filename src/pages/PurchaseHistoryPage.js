...
import { getLoggedInUserAsync, selectUserInfo } from '../redux/Slices/User/userSlice'
...
const mockTickets = [
	{
		...
		date: '10/04/2025',
		time: '19:00',
		cinema: 'BookingCinema Quốc Thanh',
		room: 'Phòng 5',
		seats: ['E7', 'E8'],
		total: 200000,
	},
	{
		...
		date: '02/04/2025',
		time: '21:15',
		cinema: 'BookingCinema Hai Bà Trưng',
		room: 'Phòng 3',
		seats: ['C3'],
		total: 95000,
	},
						...
						{mockTickets.map(ticket => (
							...
							>
								<div className="flex justify-between items-center mb-2">
									...
									<span className="text-sm text-yellow-400 font-semibold">Mã vé: {ticket.id}</span>
								</div>
								<div className="grid grid-cols-2 gap-2 text-sm">
									<p>
										<span className="font-semibold">Ngày chiếu:</span> {ticket.date}
									</p>
									<p>
										<span className="font-semibold">Giờ chiếu:</span> {ticket.time}
									</p>
									<p>
