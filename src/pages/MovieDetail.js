...
const MovieDetail = () => {
    ...
    return (
        <div className="container mx-auto p-4 text-white">
            <div className="flex">
                <img src={movie.poster} alt={movie.title} className="w-1/3 rounded-md" />
                <div className="ml-6">
                    <h1 className="text-4xl font-bold">{movie.title} ({movie.rating})</h1>
                    ...
                    <a href={movie.trailer} target="_blank" rel="noopener noreferrer">
                        <button className="mt-4 bg-red-600 px-4 py-2 rounded-md">Xem Trailer</button>
                    </a>
